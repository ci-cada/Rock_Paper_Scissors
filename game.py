...
def about_program():
    ...
    program_text=f"""Python Tkinter Rock Paper scissors
    Have Fun
    By Jussie
"""
...
#load images
image_rock=ImageTk.PhotoImage(Image.open('rock.JPG'))
image_scissors=ImageTk.PhotoImage(Image.open('scissors.JPG'))
image_paper=ImageTk.PhotoImage(Image.open('paper.JPG'))
